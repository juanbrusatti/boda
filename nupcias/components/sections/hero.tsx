  ...
  return (
    <section id="top" className="relative flex min-h-screen items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex max-w-3xl flex-col items-center px-6 text-center text-background">
        <p className="animate-[fade-up_1s_ease-out_forwards] text-xs font-light uppercase tracking-[0.45em] text-background/85">
          {event.tagline}
        </p>

        <h1 className="mt-6 text-balance font-serif text-6xl font-light leading-[0.95] tracking-tight sm:text-7xl md:text-8xl lg:text-[8.5rem]">
          {event.title}
        </h1>

        <div className="mt-8 flex flex-col items-center gap-4">
          <span className="h-px w-16 bg-background/50" />
          <p className="text-sm font-light uppercase tracking-[0.3em] text-background/90">
            {event.dateLabel}
          </p>
          <p className="text-xs font-light tracking-[0.2em] text-background/70">
            {event.locationLabel}
          </p>
        </div>
